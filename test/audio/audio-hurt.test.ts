...
import { casualtyPose, emptyCasualtyPose, FALL_TICKS, type Casualty } from '../../src/sim/crowd/casualty-motion.ts';
import { TICK_RATE } from '../../src/sim/clock.ts';
import { EMPTY_INPUT } from '../../src/sim/input.ts';
import type { StartledPedestrian } from '../../src/sim/crowd/pedestrians.ts';
