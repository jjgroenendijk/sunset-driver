...
import { buildWaterAttributes } from '../../src/render/environment/water.ts';
import { compareNumbers } from '../../src/core/sort.ts';
import { archetypeNamed } from '../../src/world/terrain/archetype.ts';
import { Heightfield } from '../../src/world/terrain/heightfield.ts';
import { MAX_WORLD_SIZE, MIN_WORLD_SIZE } from '../../src/world/size.ts';
import { coastNoise, islandAt, TERRAIN_CELL } from '../../src/world/terrain/terrain.ts';
