...
import { type RoadBeds } from '../../src/world/carve/bed.ts';
import { benchHalfWidth, CARVE_BLEND, type RoadCarve } from '../../src/world/carve/carve.ts';
import { Heightfield } from '../../src/world/terrain/heightfield.ts';
import { deckPiers, RoadGround, type DeckPier } from '../../src/world/decks/piers.ts';
import { CHUNK_TERRAIN_CELL } from '../../src/world/terrain/terrain.ts';
import { nearestRoadPlace, SurfaceIndex } from '../../src/world/terrain/surface.ts';
import { type Corridor, type Point, type RoadCurve, type WorldDescription } from '../../src/world/types.ts';
import { landPoints, pointInRing, ringArea, ringsOverlap } from '../support/helpers.ts';
import {
  FOOTPRINT_COUNT,
  MIN_FOOTPRINT_SHARE,
  MAX_FOOTPRINT_SHARE,
