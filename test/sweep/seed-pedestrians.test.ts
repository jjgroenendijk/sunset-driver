...
import { CORNER_REACH, pavementOffset } from '../../src/sim/crowd/pedestrian-route.ts';
import { AmbientPedestrians, crowdDistrictsOf, type PedestrianPose } from '../../src/sim/crowd/pedestrians.ts';
import { trafficRoadsOf } from '../../src/sim/traffic/traffic.ts';
