...
import { carrying, STASH_UNITS } from '../src/sim/market.ts';
import type { Place } from '../src/sim/on-foot.ts';
import { initPhysics, SimPhysics, type Ground } from '../src/sim/physics.ts';
import { ARREST_BRIBE, HOSPITAL_FEE } from '../src/sim/respawn.ts';
...
import {
  ...
  unitsOf,
  type SafehousePlace,
} from '../src/sim/safehouse.ts';
import { shopPlaces, shopOffers, type ShopPlace } from '../src/sim/shop.ts';
import { createSimState, type SimState } from '../src/sim/simulation.ts';
import type { Shop } from '../src/world/shops.ts';
