...
import { gripOf, holdOf, holdOver, KICK_TICKS, pointArm } from '../src/render/character-hold.ts';
import { CharacterModel } from '../src/render/character.ts';
import { poseFor } from '../src/render/character-pose.ts';
...
import { createLoadout, giveWeapon } from '../src/sim/weapon.ts';
