...
import { fillAt, PARKED_ID, PARKED_MIX, ParkedCars, type ParkedCar } from '../src/sim/parked.ts';
...
import { BAY_USES, LOT_BAY_LENGTH, LOT_BAY_WIDTH, STREET_BAY_LENGTH, type BayUse } from '../src/world/parking.ts';
