...
import { dealerPlaces } from '../../../src/sim/crime/dealer.ts';
...
import { crimeGrounds } from '../../../src/sim/city/street-crime.ts';
import { venuesOf } from '../../../src/sim/city/city-events.ts';
import { DealerMarks } from '../../../src/ui/hud/dealers.ts';
import { EnforcerMarks } from '../../../src/ui/hud/enforcers.ts';
import { EmergencyCrews } from '../../../src/ui/hud/emergency-crews.ts';
import { GiverBodies } from '../../../src/ui/hud/givers.ts';
import { MapPois } from '../../../src/ui/map/map.ts';
import { OfficerMarks } from '../../../src/ui/hud/officers.ts';
import { StreetLife } from '../../../src/ui/hud/street-life.ts';
 ...
 * talk are `test/sim/missions/sim-missions.test.ts`; this is the glue between them and the
 * screen.
 */
const SEED = 7;
