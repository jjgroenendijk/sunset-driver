...
import { eventOn, venuesOf, type LiveEvent, type Venues } from '../../../src/sim/city/city-events.ts';
import type { Place } from '../../../src/sim/player/on-foot.ts';
import { createSimState } from '../../../src/sim/simulation.ts';
import { crimeGrounds, crimesAt, SLOT_TICKS, type CrimeGround } from '../../../src/sim/city/street-crime.ts';
