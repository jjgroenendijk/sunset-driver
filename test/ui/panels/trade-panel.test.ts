...
import { GOODS, goodIndex, type Good } from '../../../src/sim/crime/contraband.ts';
import type { TradeRow } from '../../../src/sim/crime/market.ts';
import { cardFacts, heights } from '../../../src/ui/panels/trade-panel.ts';
