...
import { ParkedCars, type ParkedCar } from '../src/sim/parked.ts';
import { createTrafficState } from '../src/sim/traffic.ts';
import { BAY_USES, buildParkingBays, type ParkingBays } from '../src/world/parking.ts';
 ...
 * worlds, and the bays need the parcels, so they run on the seeds the pool cut.
 */
export function parkingChecks(): void {
  describe('parking', () => {
