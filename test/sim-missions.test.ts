...
import { FACTIONS, factionIndex, HOSTILE, standingOf } from '../src/sim/faction.ts';
import { giverPlaces, GIVER_REACH, type GiverPlace } from '../src/sim/giver.ts';
import { EMPTY_INPUT, type InputFrame } from '../src/sim/input.ts';
import { jobSites, offerFor, type JobKind, type MissionJob, type MissionWorld } from '../src/sim/job.ts';
import { HOLD_REACH, JOB_STANDING, LEG_REACH } from '../src/sim/mission.ts';
...
import { blockKeyAt, captureBlock } from '../src/sim/territory.ts';
