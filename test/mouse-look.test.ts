...
import { LOOK_HOLD, LOOK_PER_PIXEL, yawBehind } from '../src/render/camera-view.ts';
import { EMPTY_INPUT } from '../src/sim/input.ts';
import { createPlayerState } from '../src/sim/on-foot.ts';
import { createLoadout, currentWeapon, giveWeapon, stepWeapons } from '../src/sim/weapon.ts';
