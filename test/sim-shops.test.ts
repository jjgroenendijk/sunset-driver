...
import { travelRefusal } from '../src/sim/metro.ts';
import { MAX_HEALTH } from '../src/sim/on-foot.ts';
import { initPhysics, type Ground } from '../src/sim/physics.ts';
import { shopOffers, shopPlaces, shopRefusal, DOOR_REACH, type ShopPlace } from '../src/sim/shop.ts';
import { CLOTHES_HEAT, RESPRAY_PAINTS } from '../src/sim/shop-stock.ts';
