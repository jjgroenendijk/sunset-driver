...
import { insideRegion, ringsClash } from '../../src/world/city/lot-geom.ts';
import { ParcelIndex, type Parcel } from '../../src/world/city/parcels.ts';
import { BAY_SHARE, bayRing, laneHalfWidth, segmentQuad, type ParkingBays } from '../../src/world/city/parking.ts';
