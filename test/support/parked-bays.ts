import type { ParkedCars, ParkedCar } from '../../src/sim/traffic/parked.ts';
import { createTrafficState, type TrafficState } from '../../src/sim/traffic/traffic.ts';
import { BAY_USES, type BayUse, type ParkingBays } from '../../src/world/city/parking.ts';
