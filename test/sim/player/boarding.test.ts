...
import { groundUnder } from '../../../src/render/people/boarder.ts';
import { boardingFrame, DOOR_OPEN, type BoardingInput } from '../../../src/render/people/boarding.ts';
import { CharacterModel } from '../../../src/render/people/character.ts';
import { doorOf, seatOf } from '../../../src/render/vehicles/vehicle-mesh.ts';
import {
  BOARD_TICKS,
  boardingProgress,
  boardingTicks,
  ...
  walkShare,
  type BoardingState,
} from '../../../src/sim/player/boarding.ts';
import { resolveAppearance } from '../../../src/sim/player/character.ts';
import { exitPlace } from '../../../src/sim/player/on-foot.ts';
...
import { createVehicleState, ROSTER, specOf, VEHICLE_CLASSES, type VehicleClass } from '../../../src/sim/vehicles/vehicle.ts';
import { drive, finishBoarding, hills, start } from '../../support/sim-harness.ts';

/**
 * Getting into a vehicle and out of it: the record of `src/sim/player/boarding.ts`
 * that holds the player while the door is worked, and the body
 * `src/render/people/boarding.ts` draws doing it.
 */
