...
import { stepRadio } from '../../../src/sim/player/radio.ts';
...
function unit(id: number, x: number, y: number, kind: PoliceKind = 'patrol'): PoliceUnit {
  return { id, kind, task: 'chase', x, y, heading: 0, height: 0, speed: 10, health: 100, edges: [], distance: 0, planned: 0, goalX: x, goalY: y, crew: 2, doors: 0, doorTick: -1_000_000, fired: -1_000_000, incident: -1 };
}
