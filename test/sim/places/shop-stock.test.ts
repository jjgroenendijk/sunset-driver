...
import { shopPlaces, type ShopPlace } from '../../../src/sim/places/shop.ts';
import {
  BACK_ROOM,
  BACK_ROOM_ROWS,
  COUNTER_ROWS,
  ...
  stockOf,
  weaponPrice,
} from '../../../src/sim/places/shop-stock.ts';
import { AMMO_CAP, ARSENAL, fitsOf, WEAPON_IDS, weaponOf, type WeaponId } from '../../../src/sim/weapons/weapon.ts';
import { MAX_LICENCE, MIN_LICENCE, type Shop, type ShopKind } from '../../../src/world/city/shops.ts';
