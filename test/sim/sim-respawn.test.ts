...
import { MAX_HEALTH, type Place } from '../../src/sim/player/on-foot.ts';
import { initPhysics, SimPhysics, type Ground } from '../../src/sim/physics/physics.ts';
import { ARREST_BRIBE, HOSPITAL_FEE, nearestStation } from '../../src/sim/player/respawn.ts';
import { createSimState, START_MONEY, stepSim, type SimState } from '../../src/sim/simulation.ts';
import { DEFAULT_WEAPON, giveWeapon } from '../../src/sim/weapons/weapon.ts';
import { FATE_TICKS, fateLine } from '../../src/ui/hud/hud.ts';
import { stableJson } from '../support/helpers.ts';
import { drive, hills, start } from '../support/sim-harness.ts';
