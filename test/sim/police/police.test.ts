...
import { COOL_DELAY, CRIME_HEAT, decayHeat, effortFor, HEAT_CAP, heatForCrime, heatStars, raiseHeat } from '../../../src/sim/police/crime.ts';
import {
  commitCrime,
  HELICOPTER_STARS,
  hurtUnit,
  ...
  type DistrictAt,
  type PoliceUnit,
} from '../../../src/sim/police/police.ts';
import { respawn } from '../../../src/sim/player/respawn.ts';
