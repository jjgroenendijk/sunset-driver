...
import { HOTWIRE_CAP } from '../../src/sim/vehicles/theft.ts';
import { addPromoted, AmbientTraffic, promotedOf, type AmbientPose } from '../../src/sim/traffic/traffic.ts';
import { createVehicleState, rideHeight, specOf, type VehicleClass } from '../../src/sim/vehicles/vehicle.ts';
import { giveWeapon, roundSeverity, weaponOf, type WeaponId } from '../../src/sim/weapons/weapon.ts';
