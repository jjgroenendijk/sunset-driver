...
import { drawDriver, driverNamed, PERSONALITIES, STEADY, type Personality } from '../../../src/sim/traffic/driver.ts';
import { SIGNAL_CYCLE, type SignalApproach, type TrafficSignals } from '../../../src/sim/traffic/signals.ts';
import { timeTour, type Tour } from '../../../src/sim/traffic/traffic-timing.ts';
