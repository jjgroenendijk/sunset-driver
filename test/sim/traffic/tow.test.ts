...
import { createDamageState, type DamageStage } from '../../../src/sim/vehicles/damage.ts';
import { createSimState, stepSim, type SimState } from '../../../src/sim/simulation.ts';
import { addPromoted, type PromotedVehicle } from '../../../src/sim/traffic/traffic.ts';
import { stepTowing, TOW_REACH, TOW_WAIT } from '../../../src/sim/traffic/tow.ts';
