...
import {
  ...
  type AmbientPose,
  type TrafficCursor,
} from '../../../src/sim/traffic/traffic.ts';
import { compareStrings } from '../../../src/core/sort.ts';
import { SIGNAL_CYCLE } from '../../../src/sim/traffic/signals.ts';
import { ACCEL, endSpeeds } from '../../../src/sim/traffic/traffic-motion.ts';
import { TIERS } from '../../../src/world/roads/tiers.ts';
import type { Point, RoadCurve } from '../../../src/world/types.ts';
import { sweepSeeds, stableJson } from '../../support/helpers.ts';
