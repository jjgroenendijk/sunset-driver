...
import { TrafficSignals } from '../../../src/sim/traffic/signals.ts';
import { AmbientTraffic, laneOffset, type TrafficRoads } from '../../../src/sim/traffic/traffic.ts';
import { buildRoadGraph, type RoadEdge, type RoadGraph } from '../../../src/world/roads/graph.ts';
import { Heightfield } from '../../../src/world/terrain/heightfield.ts';
import { junctionShape } from '../../../src/world/junctions/junction-shape.ts';
import { buildJunctions, MAX_CUT } from '../../../src/world/junctions/junctions.ts';
import { RoadRibbons } from '../../../src/world/carve/ribbon.ts';
import { footprintHalfWidth } from '../../../src/world/roads/tiers.ts';
