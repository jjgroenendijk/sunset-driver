...
import { SIGNAL_AMBER, SIGNAL_CLEAR, SIGNAL_CYCLE, SIGNAL_GREEN, type SignalApproach, TrafficSignals } from '../../../src/sim/traffic/signals.ts';
...
import { GRID_SPACING, gridTraffic, gridTrafficRoads } from '../../support/traffic-grid.ts';
