...
import { AJAR_DENT, damageVehicle, PANELS } from '../../../src/sim/vehicles/damage.ts';
import { AJAR, LEAF_TICKS, leafTarget, stepDoors, stepLeaves } from '../../../src/sim/vehicles/doors.ts';
import { EMPTY_INPUT } from '../../../src/sim/input.ts';
import { BONNET_LEAF } from '../../../src/sim/vehicles/leaves.ts';
