...
import { SURFACE_RAISE, KERB_RISE } from '../../../src/render/roads/road-section.ts';
import { STANDING, ZONE_LOOKS } from '../../../src/sim/crowd/pedestrian-look.ts';
import { CARRIAGEWAY_RISE, PAVEMENT_RISE, pavementOffset } from '../../../src/sim/crowd/pedestrian-route.ts';
import {
  AmbientPedestrians,
  ...
  type PedestrianPose,
} from '../../../src/sim/crowd/pedestrians.ts';
import { TIERS } from '../../../src/world/roads/tiers.ts';
import type { Point } from '../../../src/world/types.ts';
import { stableJson, sweepSeeds } from '../../support/helpers.ts';
