...
import { casualtyPose, emptyCasualtyPose, restDistance, restTicks, upright } from '../../../src/sim/crowd/casualty-motion.ts';
import {
  BODY_CAP,
  collectBodies,
  hurtPerson,
  ...
  stepCasualties,
  type Blow,
} from '../../../src/sim/crowd/casualty.ts';
import { carDamage, KILL_SPEED, SHOVE_SPEED, strikeCrowd } from '../../../src/sim/vehicles/car-strike.ts';
import { personOnRay } from '../../../src/sim/crowd/crowd-contact.ts';
...
import { specOf, DEFAULT_CLASS } from '../../../src/sim/vehicles/vehicle.ts';
