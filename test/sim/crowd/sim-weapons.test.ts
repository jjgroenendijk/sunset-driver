...
import { enginePowerScale, PANELS } from '../../../src/sim/vehicles/damage.ts';
import { giveWeapon, SHOT_HEAT_CONCEALED, weaponOf, type WeaponId } from '../../../src/sim/weapons/weapon.ts';
import { ENFORCER_HEALTH, type EnforcerUnit } from '../../../src/sim/crime/enforcer.ts';
import { CREW_HEALTH, type CrewMember } from '../../../src/sim/city/emergency-crew.ts';
import { blowStrength, HIT_MEMORY } from '../../../src/sim/weapons/melee.ts';
import { CRIME_HEAT, raiseHeat } from '../../../src/sim/police/crime.ts';
import type { PedestrianPose } from '../../../src/sim/crowd/pedestrians.ts';
import { PERSON_HEALTH } from '../../../src/sim/crowd/casualty.ts';
import { hills, ramp, type Session, start, drive, finishBoarding } from '../../support/sim-harness.ts';
