...
import { footprintsTouch, type AmbientPose, type TrafficCursor } from '../../../src/sim/traffic/traffic.ts';
import { CAR_HALF_WIDTH, CAR_LENGTH, TRAM_CARS } from '../../../src/sim/transit/tram.ts';
