...
import { BONES, pedestrianRig } from '../../../src/render/people/pedestrian-rig.ts';
import { casualtyPose, emptyCasualtyPose, type Casualty } from '../../../src/sim/crowd/casualty-motion.ts';
import { KILL_SPEED } from '../../../src/sim/vehicles/car-strike.ts';
...
import { BONE_STRIDE, RAGDOLL_BONES, RAGDOLL_PARTS } from '../../../src/sim/physics/ragdoll-body.ts';
import { RAGDOLL_TICKS } from '../../../src/sim/physics/ragdoll.ts';
import { cloneSimState } from '../../../src/sim/simulation.ts';
import { stableJson } from '../../support/helpers.ts';
import { drive, ramp, start, type Session } from '../../support/sim-harness.ts';

/**
 * The Rapier ragdolls of the freshest casualties (`src/sim/physics/ragdoll.ts`): a
