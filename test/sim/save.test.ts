...
import { fitAttachment, giveWeapon } from '../../src/sim/weapons/weapon.ts';
import { inputStream, stableJson } from '../support/helpers.ts';
import { hills, TICKS } from '../support/sim-harness.ts';
 ...
 */
const PINNED = { version: 24, shape: 'bf512d15e90957b4' };
