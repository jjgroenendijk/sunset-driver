...
import {
  ...
  swingTicks,
  type MeleeHit,
} from '../../../src/sim/weapons/melee.ts';
import { createLoadout, giveWeapon, weaponOf } from '../../../src/sim/weapons/weapon.ts';
import {
  poseFor,
  STRIKE_END,
  SWING_FOLLOW,
...
} from '../../../src/render/people/character-pose.ts';
import { MeleeFx, SPARKS_PER_HIT } from '../../../src/render/weapons/melee-fx.ts';
