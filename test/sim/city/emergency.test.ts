...
import { createDamageState, FUSE_TICKS, ignite, SPREAD_RADIUS } from '../../../src/sim/vehicles/damage.ts';
import {
  CALL_RANGE,
  CALL_SEVERITY,
  callAmbulance,
  ...
  WORK_TICKS,
  type EmergencyUnit,
} from '../../../src/sim/city/emergency.ts';
import { CREW_SIZE } from '../../../src/sim/city/emergency-crew.ts';
import { douseFires, firesOf, light, stepFires } from '../../../src/sim/vehicles/fire.ts';
