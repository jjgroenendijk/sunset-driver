...
import { metroStairGeometry, SIGN_GLOW, stairPlace, stairsIn } from '../src/render/metro-mesh.ts';
import type { MetroEntrance } from '../src/world/metro.ts';
import { vergeRise } from '../src/render/road-section.ts';
