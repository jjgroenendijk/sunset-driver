/**
 * The arithmetic of the touch controls (`src/ui/touch.ts`): which browsers get
...
import { SPEED_STEP } from '../src/render/free-camera.ts';
import { isTouchDevice, pinchNotches, STICK_DEAD, STICK_RADIUS, stickVector } from '../src/ui/touch.ts';
