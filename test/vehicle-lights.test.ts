...
import { Headlights, headlampsOf, HEADLIGHT_CAP } from '../src/render/headlights.ts';
import { LampLight } from '../src/render/lamp-light.ts';
import { trafficParts } from '../src/render/traffic.ts';
import { HEAD_GLOW, TAIL_GLOW, glowOf } from '../src/render/vehicle-glow.ts';
import { LAMP, METAL, TAIL, TYRE } from '../src/render/vehicle-mesh.ts';
import { AMBIENT_CLASSES } from '../src/sim/traffic.ts';
import { createVehicleState, specOf, rideHeight, type VehicleClass } from '../src/sim/vehicle.ts';
