...
import { isMilitary } from '../src/sim/aircraft-roster.ts';
import { CEILING } from '../src/sim/flight.ts';
...
import { headingOf, rideHeight, ROSTER, type VehicleClass } from '../src/sim/vehicle.ts';
