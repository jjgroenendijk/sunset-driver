...
import { PANELS, type Panel } from '../src/sim/damage.ts';
import { initPhysics, type Ground } from '../src/sim/physics.ts';
import { DRY } from './helpers.ts';
import { drive, start, type Session } from './sim-harness.ts';
 ...
 * `+z`, and `render/vehicle-mesh.ts` draws the `+z` flank as the left panel. So
