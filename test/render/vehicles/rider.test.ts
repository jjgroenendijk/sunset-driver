...
import { seatRider } from '../../../src/render/vehicles/rider.ts';
import { saddleOf, type Saddle } from '../../../src/render/vehicles/vehicle-mesh.ts';
import { BODY_TYPES, resolveAppearance, type CharacterAppearance } from '../../../src/sim/player/character.ts';
import { createVehicleState, ROSTER, specOf } from '../../../src/sim/vehicles/vehicle.ts';
