...
import {
  ...
  RESOLUTIONS,
  tierOf,
} from '../../../src/render/frame/graphics.ts';
import { FRAME_BUDGET_MS, FULL_TIER, QUALITY_TIERS, type QualityTier } from '../../../src/render/frame/quality.ts';
import { QualityMonitor, WINDOW_MS, type QualityChange } from '../../../src/render/frame/quality-monitor.ts';
