...
import type { Batch } from '../../../src/render/streaming/batch.ts';
import { describe, expect, it } from 'vitest';
import { cellGrid } from '../../../src/render/streaming/cells.ts';
import type { PackedPlants } from '../../../src/render/streaming/chunk-payload.ts';
import { EntityFade, FADE_BAND } from '../../../src/render/camera/fade.ts';
import { createLampMaterials } from '../../../src/render/roads/lamp-material.ts';
import { createPlantMaterial } from '../../../src/render/environment/plant-material.ts';
import {
  ENTITY_CAPS,
  entityBudget,
  entityDistance,
  ...
  shadowDistance,
  thinned,
} from '../../../src/render/frame/quality.ts';
import { postGraphs } from '../../../src/render/look/post.ts';
import { MIN_RENDER_SCALE } from '../../../src/render/renderer.ts';
import { SHADOW_DISTANCE, SHADOW_MAP_SIZE } from '../../../src/render/environment/sky.ts';
import { REFLECTION_SCALE } from '../../../src/render/environment/water-surface.ts';
import { FAR_RADIUS, NEAR_RADIUS, type TilePart } from '../../../src/render/streaming/streaming.ts';
