...
import { BLOCK_PAINT, BLOCK_PLANTED, BLOCK_SOLAR, BLOCK_WATER } from '../../../src/render/buildings/block-mesh.ts';
import { buildChunkBuildings, type BuildingPlacement } from '../../../src/render/buildings/building-mesh.ts';
import { buildingOf, chunkOf, districtOf, lookupOf, placedRow } from '../../support/building-fixture.ts';
