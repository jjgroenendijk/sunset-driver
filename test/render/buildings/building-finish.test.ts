...
import { BLOCK_BEACON, BLOCK_CROWN } from '../../../src/render/buildings/block-mesh.ts';
import {
  FINISH_STEP,
  GLOW_FLUORESCENT,
  GLOW_KINDS,
  ...
  finishCode,
  finishOf,
} from '../../../src/render/buildings/building-finish.ts';
import { buildChunkBuildings, type BuildingPlacement } from '../../../src/render/buildings/building-mesh.ts';
import { beaconPhase, daylightAt, BEACON_CYCLE } from '../../../src/render/environment/daylight.ts';
import { tickAtHour } from '../../../src/render/environment/daylight.ts';
import { buildingOf, chunkOf, districtOf, lookupOf } from '../../support/building-fixture.ts';
