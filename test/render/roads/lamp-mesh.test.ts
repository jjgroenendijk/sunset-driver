...
import {
  ...
  lampsIn,
  type Lamp,
} from '../../../src/render/roads/lamp-mesh.ts';
import { LAMP_LIGHT_CAP, nearest } from '../../../src/render/roads/lamps.ts';
...
import type { RoadGap } from '../../../src/world/junctions/junctions.ts';
