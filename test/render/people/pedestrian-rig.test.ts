...
import { bakedPoint, bakeWalks, BONES, FRAMES, PART_GUITAR, pedestrianBody } from '../../../src/render/people/pedestrian-rig.ts';
import { GAITS, STRIDE_HEIGHT } from '../../../src/sim/crowd/pedestrian-look.ts';
