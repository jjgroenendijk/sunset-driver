...
import { CASUALTY_CAP, CasualtyView } from '../../../src/render/people/casualties.ts';
import { BODY_FLOATS, CasualtyPoser, ragdollMatrices } from '../../../src/render/people/casualty-pose.ts';
import { RAGDOLL_BONES } from '../../../src/sim/physics/ragdoll-body.ts';
import { BONES, JOINTS, PART_PROP, pedestrianBody } from '../../../src/render/people/pedestrian-rig.ts';
import { emptyCasualtyPose, type Casualty, type CasualtyPose } from '../../../src/sim/crowd/casualty-motion.ts';
import type { EmergencyUnit } from '../../../src/sim/city/emergency.ts';
import { dropCrew, MEDIC_SIDE, placeCrew } from '../../../src/sim/city/emergency-crew.ts';
