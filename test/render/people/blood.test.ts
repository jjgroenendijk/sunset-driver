...
import {
  ...
  type BloodMark,
  type Spatter,
} from '../../../src/render/people/blood-layout.ts';
import { DEFAULT_GORE, GORE_LEVELS } from '../../../src/render/people/gore.ts';
import { restDistance, restTicks, throwOf, type Casualty } from '../../../src/sim/crowd/casualty-motion.ts';
import type { KeyValueStore } from '../../../src/ui/menus/saves.ts';
import { DEFAULT_SETTINGS, readSettings, writeSettings } from '../../../src/ui/menus/settings.ts';
