...
import { DEFAULT_APPEARANCE, OUTFITS } from '../../../src/sim/player/character.ts';
import { GOOD_IDS } from '../../../src/sim/crime/goods.ts';
import { PROP_IDS } from '../../../src/sim/places/shop-goods.ts';
import { VEHICLE_CLASSES } from '../../../src/sim/vehicles/vehicle.ts';
import {
  clearPlaceFor,
  GALLERY_PROPS,
  GALLERY_SUBJECTS,
  layGallery,
  type GallerySubject,
} from '../../../src/render/preview/preview-gallery.ts';
