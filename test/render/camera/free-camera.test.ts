/**
 * The developer free camera (`src/render/camera/free-camera.ts`). It is the one half
 * of the tool that runs without a browser: where it stands, where it looks, and
 * how fast it flies.
 */
import { describe, expect, it } from 'vitest';
import { PerspectiveCamera } from 'three';
import { CAMERA_PITCH, FollowCamera } from '../../../src/render/camera/camera.ts';
import {
  EMPTY_FREE_INPUT,
  FAST_MULTIPLIER,
  FREE_SPEED,
  ...
  SURVEY_HEIGHT,
  SURVEY_PITCH,
} from '../../../src/render/camera/free-camera.ts';
