...
a made-up moment of each kind — the engine idling and at speed, a siren, the helicopter, a gunshot,
a crash, an explosion, a footfall, a bell, and the lot at once — through an offline audio context
and prints the peak, the loudness and how much of it was silence.
...
clips. `docs/audio.md` says why a voice's gain is not its loudness.
