...
import { metroEntrances, type MetroEntrance } from '../../world/transit/metro.ts';
import type { RoadRibbons } from '../../world/carve/ribbon.ts';
import { buildShops, type Shop } from '../../world/city/shops.ts';
import { CHUNK_TERRAIN_CELL, TERRAIN_CELL } from '../../world/terrain/terrain.ts';
import type { RoadTier, WorldDescription } from '../../world/types.ts';
import { buildChunkBuildings, buildingLookup, type BuildingLookup, type BuildingPlacement } from '../buildings/building-mesh.ts';
import { byCell, cellGrid, cellOfPart, cellsHolding, type CellGrid } from './cells.ts';
import { packFacade } from '../buildings/facade-pack.ts';
import { buildGroundAttributes, groundLookup, type GroundAttributes, type GroundLookup } from '../environment/ground.ts';
import { lampsIn, type Lamp } from '../roads/lamp-mesh.ts';
import { stairsIn, type MetroStair } from '../transit/metro-mesh.ts';
import { postersIn, type Poster } from '../signage/poster-mesh.ts';
import { ROOF_STRIDE, writeRoof } from '../buildings/roofs.ts';
import { buildChunkVegetation, plantLookup, type PlantLookup } from '../environment/plant-mesh.ts';
import type { SurfaceAt } from '../roads/pavement-mesh.ts';
import { buildChunkRoads, partsOf, raisedPartsOf } from '../roads/road-mesh.ts';
import { shopTrades, signsIn, type Sign, type TradeLookup } from '../signage/sign-mesh.ts';
