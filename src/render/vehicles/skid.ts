...
import { headingOf, isLoose, type VehicleSpec, type VehicleState, type WheelSpec, type WheelState } from '../../sim/vehicles/vehicle.ts';
import type { Surface } from '../../world/terrain/surface.ts';
import { CHUNK_TERRAIN_CELL } from '../../world/terrain/terrain.ts';
