...
import { PANELS, type DamageState, type Panel } from '../../sim/vehicles/damage.ts';
import {
  DEFAULT_CLASS,
  specOf,
  type VehicleClass,
...
export class VehicleModel {
  ...
  /** How far open the record says each leaf is, 0 shut and 1 open (`sim/vehicles/doors.ts`). */
