...
import { crowdAtHour } from '../../sim/crowd/crowd-hours.ts';
import { GAIT_NEIGHBOUR, GAITS, STRIDE_HEIGHT, type Gait } from '../../sim/crowd/pedestrian-look.ts';
import { heldTime } from '../../sim/traffic/hold.ts';
import { casualtyOf, emptyPose, startledOf, startledPose, walkingPose, type AmbientPedestrians, type PedestrianPose } from '../../sim/crowd/pedestrians.ts';
import type { SimState } from '../../sim/simulation.ts';
import type { WaitingCrowd, WaitingPassenger } from '../../sim/transit/stop-queue.ts';
