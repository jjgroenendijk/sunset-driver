 ...
 */
import { JUMP_SPEED, SPRINT_SPEED, SWIM_DEPTH } from '../../sim/player/on-foot.ts';
...
export interface CharacterMotion {
   ...
   * `src/sim/weapons/melee.ts` reads it off the record.
   */
  swing?: number;
 ...
 * `src/sim/weapons/melee.ts` answers, and a negative one leaves the pose alone.
 */
