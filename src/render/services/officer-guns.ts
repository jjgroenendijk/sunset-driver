 ...
 * 14). The officers themselves are drawn in the crowd's mesh (`ui/hud/officers.ts`),
...
import { officerWeapon, type Officer } from '../../sim/police/officer.ts';
import { STRIDE_HEIGHT } from '../../sim/crowd/pedestrian-look.ts';
import type { SimState } from '../../sim/simulation.ts';
import type { WeaponId } from '../../sim/weapons/weapon.ts';
import { officerLook } from './uniform.ts';
import { weaponGeometry } from '../weapons/weapon.ts';
import { weaponBoxes } from '../weapons/weapon-mesh.ts';
