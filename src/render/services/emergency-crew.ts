 ...
 *
 * Where each of them stands is the record's (`sim/city/emergency-crew.ts`), which
 ...
 * engine itself.
 *
 * The bodies are drawn in the crowd's own mesh (`ui/hud/emergency-crews.ts`), and
...
import {
  ...
  type CrewMember,
  type CrewRole,
} from '../../sim/city/emergency-crew.ts';
import { UNIT_BODY, type EmergencyUnit } from '../../sim/city/emergency.ts';
...
import { vary } from '../people/casualty-pose.ts';
