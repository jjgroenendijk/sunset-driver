 ...
 */
import { COUNTDOWN_CAP, ROUTE_OF, type TramDesign } from '../../sim/transit/tram.ts';
import { createCanvas, drawCentred, drawText, fillRect, textWidth, type PixelCanvas } from '../signage/pixel-canvas.ts';
