 ...
 */
import { zoomOf } from '../weapons/viewmodel.ts';
...
import {
  ...
  type DamageStage,
  type DamageState,
} from '../../sim/vehicles/damage.ts';
import { exitPlace } from '../../sim/player/on-foot.ts';
import { createSimState, type SimState } from '../../sim/simulation.ts';
import type { GiverPlace } from '../../sim/missions/giver.ts';
import type { LoadoutState } from '../../sim/weapons/weapon.ts';
...
import { frameContents } from '../frame/frame-contents.ts';
import { FULL_TIER, QUALITY_TIERS, type QualityTier } from '../frame/quality.ts';
...
import type { EmergencyView } from '../services/emergency.ts';
