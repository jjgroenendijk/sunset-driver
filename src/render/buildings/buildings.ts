 ...
 * and nothing else.
 */
import { fillOfPacked, tilePartOf } from '../streaming/batch.ts';
import type { PackedBatch } from '../streaming/chunk-payload.ts';
import { createBuildingMaterials, type BuildingMaterials } from './building-material.ts';
import type { BuildingCutaway } from '../camera/cutaway.ts';
