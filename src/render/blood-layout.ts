...
import { casualtyPose, emptyCasualtyPose, restDistance, restTicks, throwOf } from '../sim/casualty-motion.ts';
import { dead, PERSON_HEALTH, type Casualty } from '../sim/casualty.ts';
