...
import { airfieldRamp } from '../../world/transit/airfield-frame.ts';
import { RAMP_HALF } from '../../world/transit/airfields.ts';
import type { Airfield, AirfieldPart, Point } from '../../world/types.ts';
import { coloured, merged } from '../vehicles/traffic.ts';
