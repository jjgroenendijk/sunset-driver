...
import { DECK_SOFFIT } from '../../world/decks/decks.ts';
import type { RoadFrame } from '../../world/carve/ribbon.ts';
import { footprintHalfWidth, TIERS } from '../../world/roads/tiers.ts';
 ...
 * The whole reach under the surface is `DECK_SOFFIT`, which the world holds,
 * because the piers of `pier-posts.ts` stand up to it.
 */
