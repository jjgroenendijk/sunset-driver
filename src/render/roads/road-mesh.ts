...
import { piecesOf, trimRun, type Piece } from '../../world/roads/road-pieces.ts';
import { PARAPET_HEIGHT } from '../../world/decks/decks.ts';
import { footprintHalfWidth, TIERS, TRAM_LANE } from '../../world/roads/tiers.ts';
...
export { trimRun } from '../../world/roads/road-pieces.ts';
export {
  markingsOf,
  roadSection,
  structureSection,
