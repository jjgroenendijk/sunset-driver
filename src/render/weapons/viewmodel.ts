...
import { resolveAppearance, type CharacterAppearance } from '../../sim/player/character.ts';
import { swingOf } from '../../sim/weapons/melee.ts';
import { currentSlot, currentWeapon, reloading, type LoadoutState, type WeaponSpec } from '../../sim/weapons/weapon.ts';
