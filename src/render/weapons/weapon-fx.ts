 ...
 *
 * `src/sim/weapons/gunfire.ts` carries the projectiles in `SimState.projectiles`,
...
import { weaponOf, type ProjectileState, type WeaponId } from '../../sim/weapons/weapon.ts';
import { flameMaterial, smokeMaterial } from '../vehicles/puff-material.ts';
import { Puffs, smokePuff } from '../vehicles/puffs.ts';
