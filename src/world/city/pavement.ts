...
import { junctionShape } from '../junctions/junction-shape.ts';
import type { Junction } from '../junctions/junctions.ts';
import type { RoadFrame, RoadRibbons } from '../carve/ribbon.ts';
import { piecesOf, trimRun } from '../roads/road-pieces.ts';
