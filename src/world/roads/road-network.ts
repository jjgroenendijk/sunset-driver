...
import { toSegment } from '../junctions/crossing-line.ts';
import { curveDistances } from '../carve/ribbon.ts';
import { deckApart, settleCrossings, type DraftLine, type PointEdit } from '../junctions/crossing-plan.ts';
import type { CrossingNetwork } from '../junctions/crossing-rules.ts';
import { cutBack, dropPoint, FOOT_MARGIN, HALF_FEET, nudgeOff, onRamp, overpassFeet, rampsAt, sliceLine, withPointAlong, type HighwayMeet, type RampPlan } from '../junctions/diamonds.ts';
import { NetworkClearance, SAME_PLACE } from './network-clearance.ts';
import { pointOnFill } from '../junctions/overpass.ts';
