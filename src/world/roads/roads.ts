...
import { gateChoices } from '../transit/airfields.ts';
import { toSegment } from '../junctions/crossing-line.ts';
import { alleyPlan, alleySeeds, type AlleyGround } from '../city/alleys.ts';
import { ZONE_LOTS } from '../city/buildings.ts';
import { districtAt, layoutZones, zoneAt } from '../terrain/districts.ts';
...
import { zoneMinBuilt } from '../city/parcels.ts';
