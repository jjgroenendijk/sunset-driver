...
import type { Ground } from '../carve/bed.ts';
...
import { MIN_MEET } from '../roads/network-clearance.ts';
...
import { footprintHalfWidth, mayCross, mayJoin, TIERS } from '../roads/tiers.ts';
