...
import type { ParcelOwner } from '../city/parcels.ts';
import { nearestRoadSpot } from '../terrain/surface.ts';
 ...
 * stairs has to be the player the metro answers: the reach of `src/sim/transit/metro.ts`
