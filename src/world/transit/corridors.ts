...
import type { RoadEdge, RoadGraph, RoadNode } from '../roads/graph.ts';
import { Heightfield } from '../terrain/heightfield.ts';
import { deckHalfWidth, deckRuns, overWater, pierFeet, pointAlong, polylineLength, RoadGround } from '../decks/piers.ts';
import { TIERS, TRAM_LANE } from '../roads/tiers.ts';
import type {
  Corridor,
  CorridorKind,
  Point,
