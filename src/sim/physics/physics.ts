...
import { stepCrowdReactions } from '../crowd/crowd-reaction.ts';
import { stepMakeWay } from '../crowd/make-way.ts';
import { stepCasualties, type CasualtyGround } from '../crowd/casualty.ts';
import { strikeCrowd, type CarStrike } from '../vehicles/car-strike.ts';
import { stepFires } from '../vehicles/fire.ts';
import { blastDamageAt, BLAST_LIFT, CRASH_DAMAGE, hitVehicle, tickFire } from '../vehicles/damage.ts';
import { unrotate } from '../vehicles/frame.ts';
import { Drivetrain } from '../vehicles/drivetrain.ts';
import { Flight } from '../vehicles/flight.ts';
import { stepAirside, theftOf } from '../police/airside.ts';
import { GroundBodies, type Ground } from './ground-bodies.ts';
import { GroundPlaces } from './ground-places.ts';
import { deckSurfaceAt } from '../../world/decks/decks.ts';
import { Ragdolls } from './ragdoll.ts';
import { SHUNS_RAGDOLL } from './collision-groups.ts';
import { Gunfire, type ShotTarget } from '../weapons/gunfire.ts';
import { buildWalker, GRAVITY, walk, type Walker } from '../player/walker-body.ts';
...
import {
  ...
  hurt,
  reachesVehicle,
} from '../player/on-foot.ts';
import type { SimState } from '../simulation.ts';
import { TrafficBodies } from '../traffic/traffic-bodies.ts';
import { GiveWay } from '../traffic/give-way.ts';
import { buildParked, buildVehicle, readVehicle } from '../vehicles/vehicle-bodies.ts';
import { UnitBodies } from './unit-bodies.ts';
import { commitCrime, report } from '../police/police.ts';
import { reachablePromoted, swapInto } from '../vehicles/steal.ts';
import { createTheft, isLocked, stepTheft, type TheftState } from '../vehicles/theft.ts';
import { boardingDone, createBoarding, startBoarding, type BoardingState } from '../player/boarding.ts';
...
import {
  ...
  type VehicleClass,
  type VehicleSpec,
} from '../vehicles/vehicle.ts';
import { weatherAt } from '../city/weather.ts';
