...
import { casualtyPose, emptyCasualtyPose, upright } from '../crowd/casualty-motion.ts';
import { dead, hurtPerson, PERSON_HEALTH, type CasualtyGround } from '../crowd/casualty.ts';
import { BODY_RADIUS, type CrowdLookup } from '../crowd/crowd-contact.ts';
