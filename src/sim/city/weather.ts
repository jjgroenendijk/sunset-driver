 ...
 * the renderer: `src/render/environment/weather-look.ts` turns a {@link Weather} into
 * light, haze and grade, and `src/render/environment/weather-fx.ts` into rain and litter.
 */
