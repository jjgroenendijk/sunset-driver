 ...
 * the amp and the dog are drawn by `render/corners.ts`.
 */
...
import { lookOf, type Gait, type PedestrianLook } from './pedestrian-look.ts';
import { walkable } from './pedestrian-place.ts';
import { PAVEMENT_RISE, pavementOffset } from './pedestrian-route.ts';
import { emptyPose, IDLE_TICKS, type DistrictAt } from './pedestrians.ts';
import { RouteSampler, type RouteLegs, type RoutePoint } from './route-sample.ts';
import type { WaitingCrowd, WaitingPassenger } from './stop-queue.ts';
