 ...
 * each moment — is drawn by `src/render/people/boarding.ts` from the same record, so a
...
import { headingOf, type VehicleSpec, type VehicleState } from '../vehicles/vehicle.ts';
