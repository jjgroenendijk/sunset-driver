 ...
 */
import type { GoodId } from '../crime/goods.ts';
import type { VehicleClass } from '../vehicles/vehicle.ts';
import { WEAPON_IDS, weaponOf, type Attachment, type WeaponId, type WeaponSpec } from '../weapons/weapon.ts';
 ...
 * (`src/render/preview/preview-gallery.ts`) reads it, and its test holds the two lists
