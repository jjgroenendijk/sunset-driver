...
import type { PedestrianLook } from '../crowd/pedestrian-look.ts';
import { PAVEMENT_RISE, pavementOffset } from '../crowd/pedestrian-route.ts';
import { emptyPose, type PedestrianPose } from '../crowd/pedestrians.ts';
 ...
 * (`render/transit/tram-stops.ts`) rather than the kerb the buses call at.
 */
