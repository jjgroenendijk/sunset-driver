...
import { damageVehicle } from '../vehicles/damage.ts';
...
import { markTracer, type TracerEnd } from '../weapons/tracer.ts';
import { headingOf, specOf } from '../vehicles/vehicle.ts';
import { roundSeverity, weaponOf, type WeaponId } from '../weapons/weapon.ts';
