...
import { toLocal } from '../../world/transit/airfield-frame.ts';
import { isMilitary } from '../vehicles/aircraft-roster.ts';
import { TICK_RATE } from '../clock.ts';
import { heatStars, type Crime } from './crime.ts';
import { commitCrime } from './police.ts';
import type { SimState } from '../simulation.ts';
import { isAircraft, type VehicleClass } from '../vehicles/vehicle.ts';
