...
import { shiftStanding } from '../crime/faction.ts';
...
import { dollars } from '../crime/market.ts';
import { reachesVehicle } from '../player/on-foot.ts';
import type { SimState } from '../simulation.ts';
import { blockKeyAt, callWave, captured } from '../crime/territory.ts';
