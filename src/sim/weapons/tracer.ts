 ...
 * read it a frame later. `src/render/weapons/shot-fx.ts` draws the flash, the streak
 * and the burst where the round landed; `src/ui/hud/crosshair.ts` shows a hit
