...
import type { PromotedVehicle } from '../traffic/traffic.ts';
import { type VehicleSpec, type VehicleState } from '../vehicles/vehicle.ts';
import { blastEnforcers, hurtEnforcer } from '../crime/enforcer.ts';
import { blastOfficers, hurtOfficer } from '../police/officer.ts';
import { blastCrew, hurtCrew } from '../city/emergency-crew.ts';
import { PERSON_CAPSULE } from '../police/person-bodies.ts';
import { blastUnits, report, shootUnit } from '../police/police.ts';
import { blowStrength, forgetHits, markHit, SWING_HEIGHT, type CrowdSource, type HitSurface } from './melee.ts';
import { hurtPerson, type CasualtyGround } from '../crowd/casualty.ts';
import { SHUNS_RAGDOLL } from '../physics/collision-groups.ts';
import { peopleNear, personOnRay } from '../crowd/crowd-contact.ts';
import { forgetTracers, markTracer, type TracerEnd } from './tracer.ts';
import { forgetBlasts, markBlast } from './blast.ts';
import { light } from '../vehicles/fire.ts';
import {
  blastFalloff,
  bounceProjectile,
  projectileDue,
