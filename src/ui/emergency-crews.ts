 ...
 * stands is the record's (`sim/emergency-crew.ts`); the hoses and the water
 * are drawn with the unit (`render/emergency.ts`), and a medic knelt at a
 * body in `render/casualties.ts`, which is the only mesh with a kneel in it.
 *
 ...
 * and end the list.
 */
import type { CrewMember } from '../sim/emergency-crew.ts';
import type { SimState } from '../sim/simulation.ts';
import { crewLook } from '../render/emergency-crew.ts';
