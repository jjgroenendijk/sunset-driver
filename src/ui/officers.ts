 ...
 * (`render/uniform.ts`); an officer with their gun out is drawn in the `aim`
 * gait, arms out in front, and `render/officer-guns.ts` puts the gun in them.
 *
