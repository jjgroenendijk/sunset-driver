 ...
 * both put on the map.
 *
 * `src/sim/city/city-events.ts` says what is on and `src/sim/city/street-crime.ts` what
...
import {
  ...
  type LiveEvent,
  type Venues,
} from '../../sim/city/city-events.ts';
import { lookOf, type PedestrianLook } from '../../sim/crowd/pedestrian-look.ts';
import type { SimState } from '../../sim/simulation.ts';
import { CRIMES, crimesAt, type CrimeGround, type StreetCrime } from '../../sim/city/street-crime.ts';
