 ...
 * Controls, Camera (`title-camera.ts`) and Sound (`title-sound.ts`). Load game stays disabled
  ...
  private buildSettings(): HTMLElement {
    ...
    const menu = menuList(
      [
        ...
        { numeral: 'III', label: 'Sound', note: 'How loud the city is', action: () => this.show('sound') },
        { numeral: 'IV', label: 'Graphics', note: 'Comes in a later version', action: null },
      ],
      'Settings',
    );
