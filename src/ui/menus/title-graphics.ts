import { choiceOf, presetOf, STEPPED, type GraphicsChoice, type SteppedKnob } from '../../render/frame/graphics.ts';
import { QUALITY_TIERS, type QualityTier } from '../../render/frame/quality.ts';
