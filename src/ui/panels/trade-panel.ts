 ...
 *
 * The rules are in `src/sim/crime/market.ts`, `src/sim/crime/contraband.ts` and
 * `src/sim/crime/dealer.ts`, and this draws them. It wears the shop counter's layout
...
import { ShopPreview } from '../../render/shops/shop-preview.ts';
import { TICKS_PER_HOUR } from '../../sim/clock.ts';
import { GLUT, GOODS, priceRun, SPIKE, type Good } from '../../sim/crime/contraband.ts';
import { dealerAt, dealRefusal, type DealerPlace } from '../../sim/crime/dealer.ts';
import { FACTIONS, factionForCulture } from '../../sim/crime/faction.ts';
import { carrying, dealing, dollars, favourOf, tradeRows, STASH_UNITS, type TradeRow } from '../../sim/crime/market.ts';
