 ...
 *
 * The rules are in `src/sim/missions/mission.ts` and this draws them. A player walking
 ...
 */
import { giverAt, giverRefusal, type GiverPlace } from '../../sim/missions/giver.ts';
import { type JobOffer, type MissionJob, type MissionWorld } from '../../sim/missions/job.ts';
import { dollars } from '../../sim/crime/market.ts';
import { countdown, jobOffers, jobRows, visitingGiver } from '../../sim/missions/mission.ts';
