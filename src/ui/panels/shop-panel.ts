 ...
 *
 * The rules are in `src/sim/places/shop.ts` and `src/sim/places/shop-stock.ts`, and this
...
import { shopAt, shopOffers, shopRefusal, visiting, type ShopPlace } from '../../sim/places/shop.ts';
import type { ShopOffer } from '../../sim/places/shop-stock.ts';
